 ...
 */
public class TpAppServiceImpl extends TpApiServiceAbstract implements TpContactService {

    public TpAppServiceImpl(TpProperties config, WxCacheService cache, WxHttpClientService httpClient) {
