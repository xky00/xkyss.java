...
import com.xkyss.quarkus.server.dto.ValidateInfo;
...
public class ValidationExceptionMapper implements ExceptionMapper<ValidationException> {
    ...
    private Response toConstraintViolationResponse(ConstraintViolationException cve) {
        ...
        com.xkyss.quarkus.server.dto.Response<List<ValidateInfo>> r = new com.xkyss.quarkus.server.dto.Response<>(
            ErrorCode.参数校验失败, errorMessageService.getMessage(ErrorCode.参数校验失败), outputs);
        builder.entity(r);
